 ...
 * Description: Deque object that can be used both as a stack and a queue.
 */
...
public class Deque<Item> {
    ...
    /*
     * Method checks if the object contains the item v and returns a boolean value.
     * 
     * v: Object that needs to be checked if it's in the Deque 
     */
    public boolean contains(Item v)
    {
    	for (Item u: deque)
    	{
    		if (v == u)
